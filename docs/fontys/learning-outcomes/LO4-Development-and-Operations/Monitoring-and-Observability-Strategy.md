...
**Reference**: @config/prometheus.yml, @k8s/monitoring/prometheus-configmap.yaml
...
**Reference**: @notification-service/src/config/metrics.ts
...
**Reference**: @config/grafana/dashboard-services.json, @config/grafana/dashboard-infrastructure.json
...
**Reference**: @k8s/monitoring/grafana-configmap.yaml, @k8s/monitoring/grafana-deployment.yaml
...
**Reference**: @config/prometheus.yml (alerting section commented)
