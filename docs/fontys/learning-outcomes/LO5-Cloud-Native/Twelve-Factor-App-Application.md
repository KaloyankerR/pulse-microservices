...
**Reference**: @.github/workflows/pipeline.yml
...
**Reference**: @auth-service/package.json, @post-service/go.mod
...
**Reference**: @k8s/configmaps/*.yaml, @notification-service/src/config/
...
**Reference**: @notification-service/src/config/database.ts, @notification-service/src/config/redis.ts
...
**Reference**: @notification-service/Dockerfile, @k8s/services/*-deployment.yaml
...
**Reference**: @notification-service/src/server.ts, @k8s/services/*-service.yaml
...
**Reference**: @user-service/src/config/database.ts, @k8s/services/*-deployment.yaml
...
**Reference**: @k8s/README.md, @docker-compose.yml
...
**Reference**: @user-service/prisma/migrations/, @k8s/databases/
