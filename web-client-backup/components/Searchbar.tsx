            ...
            <div
              className={
                searchResults.length > 6
                  ? 'shadow-customSecondary rounded-lg max-h-96  overflow-y-scroll overflow-x-hidden scrollbar-thin  scrollbar-thumb-neutral-500 scrollbar-track-neutral-800 scrollbar-thumb-rounded-md scrollbar-track-rounded-sm'
                  : 'shadow-customSecondary rounded-lg max-h-96 '
              }
            >
